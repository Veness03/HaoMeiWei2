              ...
              {loading ? (
                ...
                movements.map(m => (
                  <tr key={m.id} className="hover:bg-stone-800/30 transition-colors">
                    <td className="p-4">
                      <div className="text-sm font-medium text-stone-200">{formatDate(m.created_at, language)}</div>
                      <div className="text-[10px] text-stone-500">{formatTime(m.created_at, language)}</div>
                    </td>
                    <td className="p-4">
