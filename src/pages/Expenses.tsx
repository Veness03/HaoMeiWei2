...
import { formatMonth, formatDate } from '@/src/lib/dateUtils';
    ...
    <div className="space-y-6">
      ...
      <div className="glass-card p-6 border-l-4 border-rose-500">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-xs font-medium text-stone-500 uppercase tracking-widest">{t('expenses.totalExpenses')} {formatMonth(monthFilter + '-01', language)}</p>
