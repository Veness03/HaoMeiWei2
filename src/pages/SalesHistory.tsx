...
import { formatDate, formatTime } from '@/src/lib/dateUtils';
      ...
      <div className="glass-card overflow-hidden bg-[#111]">
        {loading ? (
          ...
          <div className="p-12 text-center text-stone-500">
            ...
            <p className="text-sm">{t('salesHistory.noSalesDesc')} {formatDate(dateFilter, language)}</p>
          </div>
        ) : (
                ...
                <div className="flex flex-col sm:flex-row justify-between gap-4 mb-4">
                  <div>
                    ...
                    <p className="text-sm font-medium text-stone-300 mt-2">
                       {formatTime(sale.created_at, language)} • {sale.profiles?.full_name || t('salesHistory.unknownCashier')}
                    </p>
                  </div>
